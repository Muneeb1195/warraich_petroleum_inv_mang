                      ...
                      return Column(
                        children: [
                          DropdownButtonFormField<int>(
                            ...
                            items: closedShifts.map((s) {
                              return DropdownMenuItem(
                                value: s.id,
                                child: Text('${s.type.toUpperCase()} - ${s.startDate.toString().substring(0, 10)}'),
                              );
                            }).toList(),
                            ...
                            child: FilledButton.icon(
                              onPressed: _selectedShiftId == null
                                  ...
                                  : () async {
                                      ...
                                      final mappedSales = sales.map((row) => {
                                      ...
                                      await PdfService.generateShiftReport(
                                        ...
                                        date: shift.startDate.toString().substring(0, 10),
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: FilledButton.icon(
                      onPressed: () async {
                        final expenseSummary = ref.read(expenseSummaryProvider((
