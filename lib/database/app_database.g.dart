...
class $ShiftSalesTable extends ShiftSales
    with TableInfo<$ShiftSalesTable, ShiftSale> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $ShiftSalesTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
  ...
  static const VerificationMeta _openingReadingMeta = const VerificationMeta(
    'openingReading',
  );
  @override
  late final GeneratedColumn<double> openingReading = GeneratedColumn<double>(
    'opening_reading',
    aliasedName,
    false,
    type: DriftSqlType.double,
  ...
  static const VerificationMeta _closingReadingMeta = const VerificationMeta(
    'closingReading',
  );
  @override
  late final GeneratedColumn<double> closingReading = GeneratedColumn<double>(
    'closing_reading',
    aliasedName,
    false,
    type: DriftSqlType.double,
  ...
  static const VerificationMeta _cardCollectedMeta = const VerificationMeta(
    'cardCollected',
  );
  @override
  late final GeneratedColumn<double> cardCollected = GeneratedColumn<double>(
    'card_collected',
    aliasedName,
    false,
    type: DriftSqlType.double,
  ...
  static const VerificationMeta _creditCollectedMeta = const VerificationMeta(
    'creditCollected',
  );
  @override
  late final GeneratedColumn<double> creditCollected = GeneratedColumn<double>(
    'credit_collected',
    aliasedName,
    false,
    type: DriftSqlType.double,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'shift_sales';
  @override
  VerificationContext validateIntegrity(
    Insertable<ShiftSale> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    ...
    if (data.containsKey('opening_reading')) {
      context.handle(
        _openingReadingMeta,
        openingReading.isAcceptableOrUnknown(
          data['opening_reading']!,
          _openingReadingMeta,
        ),
      );
    }
    if (data.containsKey('closing_reading')) {
      context.handle(
        _closingReadingMeta,
        closingReading.isAcceptableOrUnknown(
    ...
    if (data.containsKey('card_collected')) {
      context.handle(
        _cardCollectedMeta,
        cardCollected.isAcceptableOrUnknown(
          data['card_collected']!,
          _cardCollectedMeta,
        ),
      );
    }
    if (data.containsKey('credit_collected')) {
      context.handle(
        _creditCollectedMeta,
        creditCollected.isAcceptableOrUnknown(
          data['credit_collected']!,
          _creditCollectedMeta,
        ),
      );
    }
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  ShiftSale map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ShiftSale(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
      ...
      openingReading: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}opening_reading'],
      )!,
      closingReading: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}closing_reading'],
      )!,
      ...
      cardCollected: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}card_collected'],
      )!,
      creditCollected: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
  ...
  @override
  $ShiftSalesTable createAlias(String alias) {
    return $ShiftSalesTable(attachedDatabase, alias);
  }
}

class ShiftSale extends DataClass implements Insertable<ShiftSale> {
  final int id;
  final int shiftId;
  final int productId;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['product_id'] = Variable<int>(productId);
    map['opening_reading'] = Variable<double>(openingReading);
    map['closing_reading'] = Variable<double>(closingReading);
  ...
  ShiftSalesCompanion toCompanion(bool nullToAbsent) {
  ...
  factory ShiftSale.fromJson(
    ...
    return ShiftSale(
      ...
      productId: serializer.fromJson<int>(json['productId']),
      openingReading: serializer.fromJson<double>(json['openingReading']),
      closingReading: serializer.fromJson<double>(json['closingReading']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'productId': serializer.toJson<int>(productId),
      'openingReading': serializer.toJson<double>(openingReading),
      'closingReading': serializer.toJson<double>(closingReading),
  ...
  ShiftSale copyWithCompanion(ShiftSalesCompanion data) {
    return ShiftSale(
      ...
      productId: data.productId.present ? data.productId.value : this.productId,
      openingReading: data.openingReading.present
          ? data.openingReading.value
          : this.openingReading,
      closingReading: data.closingReading.present
      ...
      cashCollected: data.cashCollected.present
          ...
          : this.cashCollected,
      cardCollected: data.cardCollected.present
          ? data.cardCollected.value
          : this.cardCollected,
  ...
  @override
  String toString() {
    return (StringBuffer('ShiftSale(')
          ..write('id: $id, ')
          ..write('shiftId: $shiftId, ')
          ..write('productId: $productId, ')
          ..write('openingReading: $openingReading, ')
          ..write('closingReading: $closingReading, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is ShiftSale &&
          ...
          other.productId == this.productId &&
          other.openingReading == this.openingReading &&
          other.closingReading == this.closingReading &&
...
class ShiftSalesCompanion extends UpdateCompanion<ShiftSale> {
  ...
  final Value<int> productId;
  final Value<double> openingReading;
  final Value<double> closingReading;
  ...
  const ShiftSalesCompanion({
    ...
    this.productId = const Value.absent(),
    this.openingReading = const Value.absent(),
    this.closingReading = const Value.absent(),
  ...
  static Insertable<ShiftSale> custom({
    ...
    Expression<int>? productId,
    Expression<double>? openingReading,
    Expression<double>? closingReading,
    ...
    return RawValuesInsertable({
      ...
      if (productId != null) 'product_id': productId,
      if (openingReading != null) 'opening_reading': openingReading,
      if (closingReading != null) 'closing_reading': closingReading,
  ...
  ShiftSalesCompanion copyWith({
    Value<int>? id,
    Value<int>? shiftId,
    Value<int>? productId,
    Value<double>? openingReading,
    Value<double>? closingReading,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (openingReading.present) {
      map['opening_reading'] = Variable<double>(openingReading.value);
    }
    if (closingReading.present) {
      map['closing_reading'] = Variable<double>(closingReading.value);
    }
    ...
    if (cardCollected.present) {
      map['card_collected'] = Variable<double>(cardCollected.value);
    }
  ...
  @override
  String toString() {
    return (StringBuffer('ShiftSalesCompanion(')
          ..write('id: $id, ')
          ..write('shiftId: $shiftId, ')
          ..write('productId: $productId, ')
          ..write('openingReading: $openingReading, ')
...
class $PayrollTable extends Payroll with TableInfo<$PayrollTable, PayrollData> {
  ...
  static const VerificationMeta _advancesMeta = const VerificationMeta(
    'advances',
  );
  @override
  late final GeneratedColumn<double> advances = GeneratedColumn<double>(
    'advances',
    aliasedName,
    false,
    type: DriftSqlType.double,
  ...
  PayrollData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return PayrollData(
      ...
      advances: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
...
final class $$ProductsTableReferences
  ...
  $$ShiftSalesTableProcessedTableManager get shiftSalesRefs {
    final manager = $$ShiftSalesTableTableManager(
      $_db,
      $_db.shiftSales,
    ).filter((f) => f.productId.id.sqlEquals($_itemColumn<int>('id')!));

    final cache = $_typedResult.readTableOrNull(_shiftSalesRefsTable($_db));
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
  }
...
class $$ProductsTableFilterComposer
  ...
  Expression<bool> shiftSalesRefs(
    ...
    final $$ShiftSalesTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.shiftSales,
      getReferencedColumn: (t) => t.productId,
      builder:
          (
            joinBuilder, {
...
class $$ProductsTableAnnotationComposer
  ...
  Expression<T> shiftSalesRefs<T extends Object>(
    ...
    final $$ShiftSalesTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.shiftSales,
      getReferencedColumn: (t) => t.productId,
      builder:
          (
            ...
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$ShiftSalesTableAnnotationComposer(
            $db: $db,
            $table: $db.shiftSales,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
...
class $$ShiftSalesTableFilterComposer
    extends Composer<_$AppDatabase, $ShiftSalesTable> {
  $$ShiftSalesTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
  ...
  ColumnFilters<double> get openingReading => $composableBuilder(
    column: $table.openingReading,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<double> get closingReading => $composableBuilder(
    column: $table.closingReading,
    builder: (column) => ColumnFilters(column),
  );
  ...
  ColumnFilters<double> get cardCollected => $composableBuilder(
    column: $table.cardCollected,
    builder: (column) => ColumnFilters(column),
  );
...
class $$ShiftSalesTableOrderingComposer
    extends Composer<_$AppDatabase, $ShiftSalesTable> {
  $$ShiftSalesTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnOrderings<double> get openingReading => $composableBuilder(
    column: $table.openingReading,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<double> get closingReading => $composableBuilder(
    column: $table.closingReading,
    builder: (column) => ColumnOrderings(column),
  );
  ...
  ColumnOrderings<double> get cardCollected => $composableBuilder(
    column: $table.cardCollected,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<double> get creditCollected => $composableBuilder(
    column: $table.creditCollected,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$ShiftSalesTableAnnotationComposer
    extends Composer<_$AppDatabase, $ShiftSalesTable> {
  $$ShiftSalesTableAnnotationComposer({
    required super.$db,
    required super.$table,
  ...
  GeneratedColumn<double> get openingReading => $composableBuilder(
    column: $table.openingReading,
    builder: (column) => column,
  );

  GeneratedColumn<double> get closingReading => $composableBuilder(
    column: $table.closingReading,
    builder: (column) => column,
  );
  ...
  GeneratedColumn<double> get cardCollected => $composableBuilder(
    column: $table.cardCollected,
    builder: (column) => column,
  );

  GeneratedColumn<double> get creditCollected => $composableBuilder(
    column: $table.creditCollected,
    builder: (column) => column,
  );
...
class $$ShiftSalesTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $ShiftSalesTable,
          ...
          $$ShiftSalesTableOrderingComposer,
          $$ShiftSalesTableAnnotationComposer,
          $$ShiftSalesTableCreateCompanionBuilder,
          $$ShiftSalesTableUpdateCompanionBuilder,
          (ShiftSale, $$ShiftSalesTableReferences),
          ShiftSale,
          PrefetchHooks Function({bool shiftId, bool productId})
        > {
  $$ShiftSalesTableTableManager(_$AppDatabase db, $ShiftSalesTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$ShiftSalesTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$ShiftSalesTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$ShiftSalesTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
                Value<int> shiftId = const Value.absent(),
                Value<int> productId = const Value.absent(),
                Value<double> openingReading = const Value.absent(),
                Value<double> closingReading = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$ShiftSalesTableReferences(db, table, e),
                ),
              )
              .toList(),
                    ...
                    if (shiftId) {
                      state =
                          state.withJoin(
                                ...
                                referencedTable: $$ShiftSalesTableReferences
                                    ._shiftIdTable(db),
                                referencedColumn: $$ShiftSalesTableReferences
                                    ._shiftIdTable(db)
                                    .id,
                              )
                              as T;
...
typedef $$ShiftSalesTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $ShiftSalesTable,
      ShiftSale,
...
final class $$PayrollTableReferences
    extends BaseReferences<_$AppDatabase, $PayrollTable, PayrollData> {
...
class $$PayrollTableOrderingComposer
  ...
  ColumnOrderings<double> get advances => $composableBuilder(
    column: $table.advances,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$PayrollTableTableManager
    extends
        RootTableManager<
          ...
          (PayrollData, $$PayrollTableReferences),
          PayrollData,
          PrefetchHooks Function({bool employeeId})
        > {
